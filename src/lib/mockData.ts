...
export const TESTIMONIALS = [
  {
    ...
    city: 'Mumbai',
    message: 'Aarogyam saved my life. Within 48 hours of my emergency call, a perfect kidney match was found.',
    image: '👨‍⚕️',
  },
  {
    name: 'Priya Sharma',
    role: 'Blood Donor',
    city: 'Delhi',
    message: 'Being part of Aarogyam gives me purpose. Knowing my donations help save lives is incredibly fulfilling.',
    image: '👩‍⚕️',
  },
  {
